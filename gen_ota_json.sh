...
FILENAME="lineage-21.0-${d}-UNOFFICIAL-${DEVICE}.zip"
...
#Update $DEVICE.json
TAG=$(echo "${DEVICE}-${d}")
url="https://github.com/ChzeRub/Lineage-21.0-OTA/releases/download/${TAG}/${FILENAME}"
...
git add $DEVICE.json
git commit -m "lineage-21.0-${d}-UNOFFICIAL-${DEVICE}"
git push
